...
//        this.startService(serviceIntent);
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O){
                ...
                ChatMainActivity.this.startForegroundService(serviceIntent);
            }else{
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(ChatMainActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(ChatMainActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(ChatMainActivity.this, "Enter a chatroom name", Toast.LENGTH_SHORT).show();
                }
            }
        });
