...
public class CustomerMessageFragment extends Fragment implements
        View.OnClickListener,
        ChatroomRecyclerAdapter.ChatroomRecyclerClickListener{

    private ProgressBar mProgressBar;
    public CustomerMainActivity myCustomerMainActivity = new CustomerMainActivity();
    //vars
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mChatroomRecyclerView = getActivity().findViewById(R.id.chatrooms_recycler_view);

        getActivity().findViewById(R.id.fab_create_chatroom).setOnClickListener(this);
        ...
        mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<android.location.Location>() {
            ...
            public void onComplete(@NonNull Task<android.location.Location> task) {
                if (task.isSuccessful()) {
                    ...
                    saveUserLocation();
                    myCustomerMainActivity.startLocationService();
                }
            }
        });
        ...
        newChatroomRef.set(chatroom).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    View parentLayout = (View) getView().findViewById(android.R.id.content);
